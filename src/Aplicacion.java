...
public class Aplicacion {
    static void main() {
        ...
        do {
            ...
            System.out.println("1. Registrar cliente."); //Alison
            System.out.println("2. Registrar producto.");
            System.out.println("3. Mostrar clientes."); //Alison
            System.out.println("4. Mostrar productos.");
            System.out.println("5. Realizar y registrar compra."); //Alejo
            System.out.println("6. Buscar cliente."); //Alison
            System.out.println("7. Buscar producto.");
            System.out.println("8. Buscar compra.");
            System.out.println("9. Consultar historial de compras de cliente."); //Jacob
